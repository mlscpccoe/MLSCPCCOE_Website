...
const TeamCard = ({ imageSrc, name, role, github, linkedin, color, rotation }) => {
	return (
		...
		>
			...
			<div
				className="w-full h-[23%] p-2 relative"
				style={{ backgroundColor: color }}
			>
					...
					{github.length > 0 && (
						<a href={github} target="_blank" rel="noopener noreferrer">
							<svg
								...
								className="hover:text-neutral-200 transition-all duration-200 absolute right-5 bottom-0"
							>
								<path
					...
					{linkedin.length > 0 && (
						<a href={linkedin} target="_blank" rel="noopener noreferrer">
							<svg
								...
								fill="none"
								xmlns="http://www.w3.org/2000/svg"
								className="hover:text-neutral-200 transition-all duration-200 absolute left-0 bottom-0"
							>
								<path
