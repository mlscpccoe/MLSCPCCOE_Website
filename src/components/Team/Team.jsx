...
const Team = () => {
	...
	const teamMembers = [
		...
		{
			imageSrc:
				"https://res.cloudinary.com/dvclc1dpd/image/upload/v1741370578/IMG-20241023-WA0047_-_SIDDHESH_PATIL-removebg-preview_s4c0z2.png",
			name: "Siddhesh Patil",
		...
		{
			imageSrc:
				"https://res.cloudinary.com/dvclc1dpd/image/upload/v1741371015/IMG_0919_-_Tushar_Badlani-removebg-preview_nwhttj.png",
			name: "Tushar Badlani",
			role: "AI/DS Head",
		...
		{
			imageSrc:
				"https://res.cloudinary.com/dvclc1dpd/image/upload/v1741369842/revati_image_-_Revati_keskar_b2jips.png",
			name: "Revati Keskar",
		...
		
		{
			...
			role: "Video editing and photography executive ",
			github: "",
			linkedin:
